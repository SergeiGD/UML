...
Описывает состояния заказа на ремонт причины изменений. В коде программы состояния хранятся в виде enumeration. Их можно просмотреть на [диаграмме классов](#markdown-header-Диаграмма-классов)
